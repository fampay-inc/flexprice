...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/subscriptions/{subscription_id}/schedules": {
            "get": {
    ...
    "definitions": {
        ...
        "SubscriptionResponse": {
            ...
            "properties": {
                ...
                "product": {
                    "description": "Product is denormalized from plan.product at subscription creation time",
                    "type": "string"
                },
                "proration_behavior": {
                    "$ref": "#/definitions/types.ProrationBehavior"
        ...
        "types.SubscriptionFilter": {
            ...
            "properties": {
                ...
                "product": {
                    "description": "Product filters by plan product (denormalized on subscription)",
                    "type": "string"
                },
                "sort": {
                    "type": "array",
