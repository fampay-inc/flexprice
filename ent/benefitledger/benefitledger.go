...
const (
	// Label holds the string label denoting the benefitledger type in the database.
	Label = "benefit_ledger"
...
// Columns holds all SQL columns for benefitledger fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldStatus,
